...
const KB = {
  ...
  courses: {
    "B.Tech CSE": { fee: "₹17,500 per year", duration: "4 years", eligibility: "12th with PCM (Physics, Chemistry, Mathematics)" },
    ...
    "IT (Information Technology)": { fee: "₹17,50,000 per year", duration: "3 years", eligibility: "12th with PCM (Physics, Chemistry, Mathematics)" }
  },
  admission: [
...
Available courses: B.Tech CSE (₹17,500/yr, 4 yrs, PCM), BCA (₹90,000/yr, 3 yrs, 12th pass), MCA (₹1,10,000/yr, 2 yrs, relevant graduation), B.Tech AI/ML (₹1,75,000/yr, 4 yrs, PCM), IT (₹17,50,000/yr, 3 yrs, PCM).
